...
var pathToImages = 'resources/dhtmlgoodies_calendar/images/'; // Relative to your HTML file
...
switch(languageCode){
	case "en":	/* English */
		...
		var monthArrayShort = ['Янв','Фев','Мрт','Апр','Май','Июн','Июл','Авг','Снт','Окт','Ноя','Дек'];
...
function displayCalendar(inputField, format, buttonObj, sPathToImages, displayTime, timeInput) {

    if (sPathToImages == "")
    { pathToImages = "resources/dhtmlgoodies_calendar/images/"; }
    else { pathToImages = sPathToImages; }
